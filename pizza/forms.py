...
# 	topping1 = forms.CharField(label='Topping 1', max_length=100, widget=forms.Textarea) # widget=forms.PasswordInput
...
class PizzaForm(forms.ModelForm):
	...
	# size = forms.ModelChoiceField(queryset=Size.objects, empty_label=None, widget=forms.RadioSelect) # widget=forms.CheckboxSelectMultiple
